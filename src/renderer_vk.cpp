...
{
	struct RendererContextNVK : public RendererContextI
	{
		RendererContextNVK()
		{
	...
	static RendererContextNVK* s_renderNVK;

	RendererContextI* rendererCreate(const Init& _init)
	{
		BX_UNUSED(_init);
		s_renderNVK = BX_NEW(g_allocator, RendererContextNVK);
		return s_renderNVK;
	}

	void rendererDestroy()
	{
		BX_DELETE(g_allocator, s_renderNVK);
		s_renderNVK = NULL;
	}
} /* namespace NVK */ } // namespace bgfx
